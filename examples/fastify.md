Fastify + Typescript Project (WIN)
V. 0.0.1 - 03/10/25

Creating Fastify + Typescript project...
...
**Creating file: `src/routes/auth.ts`**
...
**Creating file: `src/types/fastify.d.ts`**
...
**Creating file: `.vscode/launch.json`**
